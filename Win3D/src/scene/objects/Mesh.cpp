...
Mesh* Mesh::triangle() {
    ...
    indexBuffer.emplace_back(1, 2, 3);
...
Mesh* Mesh::cube() {
    ...
    indexBuffer.emplace_back( 5, 3, 1 );
    indexBuffer.emplace_back( 3, 8, 4 );
    indexBuffer.emplace_back( 7, 6, 8 );
    indexBuffer.emplace_back( 2, 8, 6 );
    indexBuffer.emplace_back( 1, 4, 2 );
    indexBuffer.emplace_back( 5, 2, 6 );
    indexBuffer.emplace_back( 5, 7, 3 );
    indexBuffer.emplace_back( 3, 7, 8 );
    indexBuffer.emplace_back( 7, 5, 6 );
    indexBuffer.emplace_back( 2, 4, 8 );
    indexBuffer.emplace_back( 1, 3, 4 );
    indexBuffer.emplace_back( 5, 1, 2 );
